...
- `main` is protected: changes land by pull request with passing status checks.
  Direct pushes are reserved for the automated forecast-data commits produced by
  the scheduled scoring workflows, which write only under `dist/`.
